...
func TestGetScoreboardData(t *testing.T) {
	...
	result := client.GetScoreboardData("2021")
	assert := assert.New(t)
...
func TestGetBoxscoreData(t *testing.T) {
	...
	result := client.GetBoxscoreData("20211225", "0022100489")
	assert := assert.New(t)
...
func TestGetPlayersData(t *testing.T) {
	...
	result := client.GetPlayersData("2021")
	assert := assert.New(t)
...
func TestGetPlayerStatsData(t *testing.T) {
	...
	result := client.GetPlayerStatsData("2021", "203507")
	assert := assert.New(t)
...
func TestGetTeamsData(t *testing.T) {
	...
	result := client.GetTeamsData("2021")
	assert := assert.New(t)
